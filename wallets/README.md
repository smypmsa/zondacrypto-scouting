...
| Address | Chains | What it is | Activity (chain → date span / event counts) | Detail |
|---|---|---|---|---|
| `16aEn4p6hK4FMpLtJGpoQZMZ946sDg1Z6n` | Bitcoin | Disclosed BTC cold reserve | BTC: 2016-03-06 → 2026-05-08, 39 tx, all UTXOs unspent (4,503.26 BTC balance) | [→](bitcoin/16aEn4p6-cold-reserve.md) |
| WalletExplorer cluster `BitBay.net` (26,014 addresses) | Bitcoin | Post-2019 operational hot-wallet cluster | BTC: 2019-05-13 → 2025-08-24, 321,245 tx (cluster total) | [→](bitcoin/bitbay-net-cluster.md) |
| `0xd388…8046` family (3 addresses incl. Zonda 6) | Polygon | Zonda Polygon-side vanity-suffix cluster | per-address activity in the cluster file (table) | [→](polygon/zonda-d388-family-polygon.md) |
...
| `0x5bff49eec8f76c066f979a818187b9732ac69503` | Ethereum | Zonda Deposit Funder 1 | ETH: 2023-10-31 → 2026-04-27, ≥10k native / 1,255 ERC-20 | [→](ethereum/zonda-deposit-funder-1.md) |
| `0x818ab3c61f66e975b8e6290c20999d6749f60d8d` | Ethereum | Zonda Deposit Funder 2 | ETH: 2021-04-12 → 2023-11-06, ≥10k native / 15 ERC-20 (dormant after 2023-11) | [→](ethereum/zonda-deposit-funder-2.md) |
| `0x2d8eA194902Bc55431420BD26Be92b0782dCe91D` | Ethereum | ZND token contract | ETH: 2024-10-21 → 2026-05-13, ≥10k native / 19 ERC-20 | [→](ethereum/znd-token.md) |
| `0x43a8a5b11b2f82866ad7dcef2c0a18e78e77399b` | Ethereum | ZND deployer | ETH: 2024-10-18 (single day), 5 native / 0 ERC-20 | [→](ethereum/znd-deployer.md) |
| `0xcb3d2be5386a13c87944f9384214ead9a6dba792` | Ethereum | ZNDStaking contract (owner of ZND token) | ETH: 2024-10-18 → 2026-04-05, 430 native / 369 ERC-20 | [→](ethereum/znd-staking.md) |
| `0x08d807a320d5986eb7c4f086bbab974c8db210da` | Ethereum | ZNDStaking owner EOA | ETH: 2024-10-18 (single day), 4 native / 0 ERC-20 | [→](ethereum/zndstaking-owner.md) |
| `0x41c31f690873ec5a642dd374e2f2dd1528d05730` | Ethereum | ZNDStaking `s_specialAccount` | ETH: 2024-12-17 → 2026-02-13, 14 native / 12 ERC-20 | [→](ethereum/znd-special-account.md) |
| `0x36ac695293d35bd90586b5353471c2004407ef6e` | Ethereum | ZNDStaking `s_withdrawalAccount` | ETH: no on-chain activity (never sent or received a transaction at the time of probing) | [→](ethereum/znd-withdrawal-account.md) |
| `0xae4f32dfa85b9e8c424a9604e7bf1d8128859943` | Ethereum | ZNDStaking `s_zndPlatform` | ETH: 2024-10-18 → 2026-03-28, 206 native / 193 ERC-20 | [→](ethereum/znd-platform.md) |
| `0xc2FdA18D62C8688902741Da1e3c5BE65C86BAB07` | Ethereum | TMPL token contract (PKOl sponsorship vehicle) | ETH: 2026-01-29 → 2026-05-10, 126 native / 1 ERC-20 | [→](ethereum/tmpl-token.md) |
| `0x82c829237159287dac6fc62eb139e6a89195900c` | Ethereum | Zonda Deposit Wallet | ETH: 2022-11-28 → 2026-04-03, 262 native / 351 ERC-20 | [→](ethereum/zonda-deposit-wallet-82c829.md) |
| `0x56d943aea92b099228b31f01cd12bd4aa39b4778` | Ethereum | Zonda (BitBay) 0x56d943…4778 (PARTIAL) | ETH: 2025-08-04 → 2026-05-13, ≥10k native / ≥10k ERC-20 | [→](ethereum/zonda-bitbay-56d943.md) |
| `0x879882c59d9cc548d6c0e7d0238e8aa40858b54f` | Ethereum | Zonda (BitBay) 0x879882…b54f (PARTIAL) | ETH: 2021-03-31 → 2026-04-02, 1,259 native / 2,112 ERC-20 | [→](ethereum/zonda-bitbay-879882.md) |
